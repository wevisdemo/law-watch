import { GOV_PARTY, OPP_PARTY, FREE_PARTY, getPartyImage } from './parties';
...
export const PARTY_CHOICES = ['เลือกทุกพรรค', ...GOV_PARTY, ...OPP_PARTY, ...FREE_PARTY] as const;
export const PARTY_DROPDOWN_CHOICES: DropdownChoiceType[] = [
	...
	{ text: 'ฝ่ายอิสระ', border: true, bold: true, readonly: true },
	...FREE_PARTY.map((name) => ({
		text: name,
		image: getPartyImage(name)
	}))
...
export const VOTEPARTY_CHOICES = [...GOV_PARTY, ...OPP_PARTY, ...FREE_PARTY] as const;
